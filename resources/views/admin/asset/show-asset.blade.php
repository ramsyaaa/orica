											...
											<table class="table custom-table table-hover table-hover">
                                                <tbody>
													...
													<tr>
														...
														<td> {{ $asset->balance_sheet_account }} </td>
													</tr>
													<tr>
														<th> Balance Sheet Account Description </th>
														<td> {{ $asset->balance_sheet_account_description }} </td>
													</tr>
													<tr>
														<th> Asset Number </th>
													...
													<tr>
														...
														<td> {{ $asset->asset_class_number }} </td>
													</tr>
													<tr>
														<th> Asset Class </th>
													...
													<tr>
														...
														<td> {{ $asset->asset_cost_center_number }} </td>
													</tr>
													<tr>
														<th> Asset Cost Center </th>
														<td> {{ $asset->asset_cost_center }} </td>
													</tr>
													<tr>
														<th> Location Id </th>
													...
													<tr>
														...
														<td> {{ $asset->first_acquisition_period }} </td>
													</tr>
													<tr>
														<th> Capitalized On </th>
														<td> {{ $asset->capitalized_on }} </td>
													</tr>
													<tr>
														<th> Dep Start Date </th>
														<td> {{ $asset->dep_start_date }} </td>
													</tr>
													<tr>
														<th> Planned Useful Life </th>
														<td> {{ $asset->planned_useful_life }} </td>
													</tr>
													<tr>
														<th> Apc Reporting Date Planned </th>
														<td> {{ $asset->apc_reporting_date_planned }} </td>
													</tr>
													<tr>
														<th> Ordinary Depreciation Reporting Date Posted </th>
														<td> {{ $asset->ordinary_depreciation_reporting_date_posted }} </td>
													</tr>
													<tr>
														<th> Unplanned Depreciation Reporting Date Posted </th>
														<td> {{ $asset->unplanned_depreciation_reporting_date_posted }} </td>
													</tr>
													<tr>
														<th> Netbook Value Reporting Date Planned </th>
														<td> {{ $asset->netbook_value_reporting_date_planned }} </td>
													</tr>
													<tr>
														<th> Last Verification Date </th>
														<td> {{ $asset->last_verification_date }} </td>
													</tr>
                                                    <tr>
