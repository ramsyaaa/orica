...
<div class="form-group{{ $errors->has('asset_name') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_name', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('asset_description') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_description', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('balance_sheet_account') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('balance_sheet_account', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('balance_sheet_account_description') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('balance_sheet_account_description', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('asset_number') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_number', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('asset_subnumber') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_subnumber', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('asset_class_number') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_class_number', '<p class="help-block text-danger">:message</p>') !!}
</div>
...
<div class="form-group{{ $errors->has('asset_cost_center_number') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_cost_center_number', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('asset_cost_center') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('asset_cost_center', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('location_id') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('location_id', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('first_acquisition_period') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('first_acquisition_period', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('capitalized_on') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('capitalized_on', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('dep_start_date') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('dep_start_date', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('planned_useful_life') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('planned_useful_life', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('apc_reporting_date_planned') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('apc_reporting_date_planned', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('ordinary_depreciation_reporting_date_posted') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('ordinary_depreciation_reporting_date_posted', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('unplanned_depreciation_reporting_date_posted') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('unplanned_depreciation_reporting_date_posted', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('netbook_value_reporting_date_planned') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('netbook_value_reporting_date_planned', '<p class="help-block text-danger">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('last_verification_date') ? 'has-error' : ''}}">
    ...
    {!! $errors->first('last_verification_date', '<p class="help-block text-danger">:message</p>') !!}
</div>
